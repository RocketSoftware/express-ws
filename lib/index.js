...
const websocketUrl = require('./websocket-url').default;
const addWsMethod = require('./add-ws-method').default;

const CODE_INTERNAL_SERVER_ERROR = 1011;

exports.default = function expressWs(app, httpServer, options = {}) {
  ...
  wsServer.on('connection', (socket, request) => {
    ...
    socket.on('error', function(error) {
      socket.close(CODE_INTERNAL_SERVER_ERROR, 'Internal Server Error');
    });
